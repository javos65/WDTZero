 ...
 * Created by John V. - 2019 V 1.2.0
 * 
...
//            w=CNT[3]EWen[1]  x=DIV[4]  y=PER[4]  z=EW[4]   ==> PER[4] MUST BE LARGER THAN EW[4] ! -> otherise HARD RESET IS QUICKER THAN THE EW-ISR ROUTINE
//                     HeX[0wxyz]     
